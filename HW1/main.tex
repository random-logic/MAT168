...
Start with the feasible solution at:
...
Increasing $x_1$ will violate a constraint. Attempt to replace non-basic variable $x_3$.
$\\ x_3 = 5 - 3 * \frac{3}{2}$
$\\ \frac{1}{2}x_3 = \frac{3}{2} - \frac{3}{2} \to x_3 = 0$


Increasing $x_1, x_3$ will violate a constraint. Increasing $x_2, w_2$ decreases the objective function. Therefore, the optimal solution is:
$\\x_1, x_2, x_3 = 0$
$\\x_4 = \frac{3}{2}$
...
%% ?? Truncate bottom and restart, maximize original with the given dictionaries
